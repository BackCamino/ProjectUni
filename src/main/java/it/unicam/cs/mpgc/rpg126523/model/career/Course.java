...
public class Course {
    ...
    public Course(int id,String name,int cfu, Exam exam, CourseStatus status) {
    ...
    public Course(int id,String name,int cfu, Exam exam) {
        this(id,name, cfu,exam, CourseStatus.TO_ATTEND);
    }
